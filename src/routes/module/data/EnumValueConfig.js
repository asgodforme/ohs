...
const queryFields = {
  ...
  fieldNames: ['sysAlias', 'sysChineseNme', 'schema', 'enumValueName', 'enumValueName', 'enumValueAlias', 'enumValue', 'enumChineseValue'],
}
